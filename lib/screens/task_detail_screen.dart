...
class _TaskDetailScreenState extends State<TaskDetailScreen> {
  ...
  Future<void> _saveToDo() async {
    ...
    if(detailState == DetailState.edit){
      if(editName == ""){
        editName = titleController.text.trim();
      }
      await FileService.renameToDo(_toDo, editName);
    }
                                ...
                                Row(
                                  children: [
                                    ...
                                    SizedBox(
                                      ...
                                      child: TextField(
                                        onTap: (){
                                          detailState == DetailState.edit ? editName = titleController.text.trim().toString() : "";
                                        },
